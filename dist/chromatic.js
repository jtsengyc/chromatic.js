...
(function() {
  ...
  Chromatic.GalleryView = (function() {
    ...
    GalleryView.prototype.layout = function() {
      ...
      viewport_width = this.el.outerWidth() - parseInt(this.el.css('paddingLeft')) - parseInt(this.el.css('paddingRight'));
...
(function() {
  ...
  Chromatic.GalleryPhotoView = (function() {
    function GalleryPhotoView(parent, photo, options) {
      ...
      this.onclickFunc = typeof options.click === 'function' ? (function() {
        return options.click.apply(photo, arguments);
      }) : this.zoom;
      this.el.on('click', this.onclickFunc);
    }
